...
$event = \mod_qa\event\course_module_instance_list_viewed::create($params);
$event->add_record_snapshot('course', $course);
$event->trigger();

$strname = get_string('modulenameplural', 'mod_qa');
$PAGE->set_url('/mod/qa/index.php', array('id' => $id));
...
$currentsection = '';
foreach ($modinfo->instances['qa'] as $cm) {
    $row = array();
    if ($usesections) {
